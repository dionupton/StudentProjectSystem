...
/*
    This JSF is used for listing login transactions for the admin.
*/   

@Named("LoginTransactionBean")
@SessionScoped
public class LoginTransactionListingBean implements Serializable {
...
/*
    Returns all login transaction logs.
    Will return the specific login transaction logs for a specified student or supervisor if they have been checked on the web page.
*/       
    public List returnTransactionLogs() {
        List tl = userStore.getAllTransactionLogins();
        ...
        if ((supervisorlist != null && studentlist != null) && (checkedSupervisor != null || checkedStudent != null)) {
            ...
            for (int i = 0; i < tl.size(); i++) {
                ...
                System.out.println("!!! " + s.getTransaction_log());
        ...
        return userStore.getAllTransactionLogins();
    }

/*
    Sets the passed supervisor as the checkedSupervisor. This is used for filtering the transaction login logs.
*/       
    public String checkSupervisor(String superv) {
        ...
        return "transactionloginlogs";
    }

/*
    Sets the passed student as the checkedStudent. This is used for filtering the transaction login logs.
*/       
